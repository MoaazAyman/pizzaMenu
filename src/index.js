...
function Header() {
  return (
    <header className="header">
      <h1>Fast React Pizza Copmany.</h1>
    </header>
  );
}
...
function Menu() {
  ...
  let pizzaListLength = pizzaList.length;
  return (
    <main className="menu">
      <h2> Our Menu</h2>
    ...
    <footer className="footer">
      <div className="order">
        {isOpen ? (
          ...
          <p>
            We are happy to welcome you between {openTime}:00 and {closeTime}:00
          </p>
        )}
...
function Order({ closeTime, openTime }) {
  return <p> We are open till {closeTime}:00, come vist us or order online!</p>;
}
